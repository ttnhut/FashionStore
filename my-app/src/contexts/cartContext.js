...
function CartProvider(props) {
  ...
  //     const isExisted = prevItems.findIndex((item) => item.id === newItems.id);
  //     if (isExisted !== -1) {
  //       prevItems[isExisted].quantity += prevItems[isExisted].quantity;
  //       return [...prevItems];
  //     }
  //     return [...prevItems, { ...newItems, quantity: 1 }];
  //     const isExisted = prevItems.some((item) => item.id === newItems.id);
  //     if (isExisted) {
  //       return [...prevItems];
  //     }
  ...
  function addToCart(newsItems) {
    ...
    // setCartItems((prevItems) => {
    //   if (!productInCart) {
    //     return [...prevItems, { ...newsItems, quantity: 1 }];
    //   } else {
    //     let newCart = [...prevItems];
    //     const objIndex = newCart.findIndex((obj) => obj.id === newsItems.id);
